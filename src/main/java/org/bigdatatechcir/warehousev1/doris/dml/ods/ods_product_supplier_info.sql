CREATE TABLE `ods_product_supplier_info` (
  `supplier_id` bigint(20)  COMMENT '供应商ID',
  `supplier_code` varchar(200)  COMMENT '供应商编码',
  `supplier_name` varchar(200)  COMMENT '供应商名称',
  `supplier_type` tinyint(4)  COMMENT '供应商类型：1.自营，2.平台',
  `link_man` varchar(200)  COMMENT '供应商联系人',
  `phone_number` varchar(200) COMMENT '联系电话',
  `bank_name` varchar(200)  COMMENT '供应商开户银行名称',
  `bank_account` varchar(200)  COMMENT '银行账号',
  `address` varchar(200)  COMMENT '供应商地址',
  `supplier_status` tinyint(4)  COMMENT '状态：0禁止，1启用',
