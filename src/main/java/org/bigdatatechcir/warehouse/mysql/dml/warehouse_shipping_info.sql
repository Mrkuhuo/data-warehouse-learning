...
CREATE TABLE `warehouse_shipping_info` (
  `ship_id` int unsigned NOT NULL AUTO_INCREMENT COMMENT '主键ID',
  ...
  PRIMARY KEY (`ship_id`)
) ENGINE=InnoDB AUTO_INCREMENT=262 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='物流公司信息表';