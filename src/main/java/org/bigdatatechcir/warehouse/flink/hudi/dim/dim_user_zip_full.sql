...
insert into hudi_dim.dim_user_zip_full(id, k1, login_name, nick_name, name, phone_num, email, user_level, birthday, gender, create_time, operate_time, start_date, end_date)
select
    id,
    k1,
    login_name,
