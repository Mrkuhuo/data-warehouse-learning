-- 从kafka 中获取数据
CREATE TABLE IF NOT EXISTS generate_product_supplier_info(
    ...
    'connector' = 'kafka',
    'topic' = 'generate_product_supplier_info',
    'properties.bootstrap.servers' = '192.168.154.131:9092',
    'properties.group.id' = 'generate_product_supplier_info',
...
-- sql逻辑代码
insert into ods_generate_product_supplier_info select * from default_catalog.default_database.generate_product_supplier_info;