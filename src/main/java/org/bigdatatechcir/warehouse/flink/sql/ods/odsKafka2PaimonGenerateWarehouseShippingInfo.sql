-- 从kafka 中获取数据
CREATE TABLE IF NOT EXISTS generate_warehouse_shipping_info(
    ...
    'connector' = 'kafka',
    'topic' = 'generate_warehouse_shipping_info',
    'properties.bootstrap.servers' = '192.168.154.131:9092',
    'properties.group.id' = 'generate_warehouse_shipping_info',
...
-- sql逻辑代码
insert into ods_generate_warehouse_shipping_info select * from default_catalog.default_database.generate_warehouse_shipping_info;