-- DROP TABLE IF EXISTS ods.ods_order_refund_info_full;
CREATE TABLE ods.ods_order_refund_info_full
(
...
(
    ...
    "bloom_filter_columns" = "id,user_id,order_id,sku_id",  -- 为高频过滤字段创建布隆过滤器，加速WHERE查询
