-- DROP TABLE IF EXISTS ods.ods_ware_sku_full;
CREATE TABLE ods.ods_ware_sku_full
(
    ...
    `stock_locked`  BIGINT COMMENT '锁定库存数'
)
...
(
    ...
    "bloom_filter_columns" = "id,sku_id,warehouse_id",  -- 为高频过滤字段创建布隆过滤器，加速WHERE查询
