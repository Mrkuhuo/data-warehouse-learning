-- DROP TABLE IF EXISTS ods.ods_payment_info_full;
CREATE TABLE ods.ods_payment_info_full
(
...
(
    ...
    "bloom_filter_columns" = "id,out_trade_no,order_id,user_id",  -- 为高频过滤字段创建布隆过滤器，加速WHERE查询
