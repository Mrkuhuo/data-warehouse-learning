-- DROP TABLE IF EXISTS ods.ods_spu_sale_attr_value_full;
CREATE TABLE ods.ods_spu_sale_attr_value_full
(
    `id`           VARCHAR(255) COMMENT '编号',
    `k1`           DATE NOT NULL COMMENT '分区字段',
    `spu_id`       STRING COMMENT 'spu_id',
    `base_sale_attr_id` STRING COMMENT '销售属性id',
...
(
    ...
    "bloom_filter_columns" = "id,spu_id,base_sale_attr_id",  -- 为高频过滤字段创建布隆过滤器，加速WHERE查询
