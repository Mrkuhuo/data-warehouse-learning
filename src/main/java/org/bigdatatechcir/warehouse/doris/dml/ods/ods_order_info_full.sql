CREATE TABLE ods.ods_order_info_full
(
    `id`                     VARCHAR(255) COMMENT '订单号',
    ...
    `refundable_time`        STRING COMMENT '可退款日期',
...
(
    ...
    "bloom_filter_columns" = "id,user_id,order_status",  -- 为高频过滤字段创建布隆过滤器，加速WHERE查询
