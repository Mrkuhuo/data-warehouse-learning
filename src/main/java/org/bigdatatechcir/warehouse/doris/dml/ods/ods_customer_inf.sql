CREATE TABLE `ods_customer_inf` (
  `customer_inf_id` bigint COMMENT '自增主键ID',
  `customer_id` bigint COMMENT 'customer_login表的自增ID',
  `customer_name`  varchar(200) NOT NULL COMMENT '用户真实姓名',
  `identity_card_type` tinyint NOT NULL DEFAULT '1' COMMENT '证件类型：1 身份证，2 军官证，3 护照',
  `identity_card_no`  varchar(200) DEFAULT NULL COMMENT '证件号码',
  `mobile_phone` bigint DEFAULT NULL COMMENT '手机号',
  `customer_email`  varchar(200) DEFAULT NULL COMMENT '邮箱',
