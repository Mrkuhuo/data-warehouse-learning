-- DROP TABLE IF EXISTS dwd.dwd_marketing_activity_full;
CREATE TABLE dwd.dwd_marketing_activity_full
(
...
(
    ...
    "bloom_filter_columns" = "id,activity_id",  -- 为高频过滤字段创建布隆过滤器，加速WHERE查询
