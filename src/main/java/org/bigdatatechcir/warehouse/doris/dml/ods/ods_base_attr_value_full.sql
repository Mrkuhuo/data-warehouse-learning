-- DROP TABLE IF EXISTS ods.ods_base_attr_value_full;
CREATE TABLE ods.ods_base_attr_value_full
(
...
(
    ...
    "bloom_filter_columns" = "id,value_name,attr_id",  -- 为高频过滤字段创建布隆过滤器，加速WHERE查询
