-- DROP TABLE IF EXISTS dwd.dwd_marketing_coupon_info_full;
CREATE TABLE dwd.dwd_marketing_coupon_info_full
(
...
(
    ...
    "bloom_filter_columns" = "id,coupon_id,range_type",  -- 为高频过滤字段创建布隆过滤器，加速WHERE查询
