-- DROP TABLE IF EXISTS ods.ods_order_status_log_full;
CREATE TABLE ods.ods_order_status_log_full
(
...
(
    ...
    "bloom_filter_columns" = "id,order_id,order_status",  -- 为高频过滤字段创建布隆过滤器，加速WHERE查询
