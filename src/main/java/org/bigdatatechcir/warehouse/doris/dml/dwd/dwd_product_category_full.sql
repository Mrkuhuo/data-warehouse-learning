-- DROP TABLE IF EXISTS dwd.dwd_product_category_full;
CREATE TABLE dwd.dwd_product_category_full
(
...
(
    ...
    "bloom_filter_columns" = "id,category_id,parent_id",  -- 为高频过滤字段创建布隆过滤器，加速WHERE查询
