-- DROP TABLE IF EXISTS dwd.dwd_user_info_full;
CREATE TABLE dwd.dwd_user_info_full
(
...
(
    ...
    "bloom_filter_columns" = "id,user_id,phone_num,email",  -- 为高频过滤字段创建布隆过滤器，加速WHERE查询
