-- DROP TABLE IF EXISTS dwd.dwd_tool_coupon_order_inc;
CREATE TABLE dwd.dwd_tool_coupon_order_inc
(
    ...
    `original_amount`   DECIMAL(16, 2) COMMENT '订单原始金额',
...
(
    ...
    "bloom_filter_columns" = "id,coupon_id,user_id,order_id",  -- 为高频过滤字段创建布隆过滤器，加速WHERE查询
