-- DROP TABLE IF EXISTS ods.ods_ware_order_task_full;
CREATE TABLE ods.ods_ware_order_task_full
(
...
(
    ...
    "bloom_filter_columns" = "id,order_id,ware_id",  -- 为高频过滤字段创建布隆过滤器，加速WHERE查询
