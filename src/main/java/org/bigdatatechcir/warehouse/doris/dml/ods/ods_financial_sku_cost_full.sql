-- DROP TABLE IF EXISTS ods.ods_financial_sku_cost_full;
CREATE TABLE ods.ods_financial_sku_cost_full
(
    ...
    `is_lastest`   STRING COMMENT '是否最新',
    `sku_cost`     DECIMAL(16, 2) COMMENT '成本',
...
(
    ...
    "bloom_filter_columns" = "id,sku_id,busi_date",  -- 为高频过滤字段创建布隆过滤器，加速WHERE查询
