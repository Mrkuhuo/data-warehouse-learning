-- DROP TABLE IF EXISTS ods.ods_activity_sku_full;
CREATE TABLE ods.ods_activity_sku_full
(
...
(
    ...
    "bloom_filter_columns" = "id,activity_id,sku_id",  -- 为高频过滤字段创建布隆过滤器，加速WHERE查询
