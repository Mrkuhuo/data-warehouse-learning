-- DROP TABLE IF EXISTS dwd.dwd_trade_cancel_detail_inc;
CREATE TABLE dwd.dwd_trade_cancel_detail_inc
(
...
(
    ...
    "bloom_filter_columns" = "id,order_id,user_id,sku_id",  -- 为高频过滤字段创建布隆过滤器，加速WHERE查询
