-- DROP TABLE IF EXISTS ods.ods_user_address_full;
CREATE TABLE ods.ods_user_address_full
(
...
(
    ...
    "bloom_filter_columns" = "id,user_id,province_id",  -- 为高频过滤字段创建布隆过滤器，加速WHERE查询
